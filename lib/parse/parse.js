...
var configuration = require('../configuration/conf.js');
var plugin = require('../plugin/');
var settings = require('../settings').slidesSettings;
...
module.exports = {
  ...
  parseAndPersist: coroutine(function *parseAndPersistGen(slideshow_id){
    ...
    yield settings.createSlidesSettings({
    ...
    // Create exercises' settings
    // var result = yield settings.createExerciseSettings({
