...
Parser.prototype.parsePresentation = function(option){
  option.html = this.assignIdsToAsqElements(option.html);
  return hooks.doHook('parse_html', option).then(function(option){
    return Promise.resolve(option);
  });
}

Parser.prototype.parsePresentationSettings = function(option){
  return hooks.doHook('parse_presentation_settings', option).then(function(option){
    return Promise.resolve(option);
  });
}
