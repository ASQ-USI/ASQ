...
Parser.prototype.getExercisesPerSlide = function(html, exerciseTag){
  assert(_.isString(html) && (! _.isEmpty(html)), 
    "Argument `html` should be a non empty string");
  ...
  var slidesIds = adapters.revealAsqFork.getSlidesTree(html).steps;
...
Parser.prototype.getQuestionsPerSlide = function(html){
