...
//     url: 'ldap://192.168.64.1:389',
//     adminDn: 'campus\\triglv',
//     adminPassword: 'pas4cami',
//     bindDN: 'campus\\triglv',
//     bindCredentials: 'pas4cami',
//     searchBase: 'dc=usilu,dc=net',
//     searchFilter: '(&(objectClass=person)(sAMAccountName={{username}}))'
...
//   // client.bind('campus\\triglv', 'pas4cami', function(err) {
//   //   if (err) return console.log(err.toString());
//   //   isLDAPUsername('triglv', function(){
...
function validateLdapUser(req, res, next){
  ...
  ldapAuth.authenticate(username, password, function (err, user) {
    if(err){
      if (_.contains(err, "no such user") 
...
// authenticateLDAP('triglv', 'pas4cami')
