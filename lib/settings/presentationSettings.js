...
module.exports = {
  ...
  updateAllExercisesSettings: coroutine(function* updateExerciseSettingsGen(html, slideshow_id) {
    var slideshow = yield Slideshow.findById(slideshow_id).exec();
    var pSettings = yield slideshow.getSettings();

    var settings = {};
    pSettings.forEach(function(s, index){
