...
module.exports = {
    ...
    for ( var key of keys ) {
      ...
      for ( var id of exerciseIdsPerSlides ) {
        ...
        slide.exercises.push({
          ...
          settings: yield exercise.listSettings()
        });
      }
  ...
  createDefaultSettingsForNewPresentation: coroutine(function*createDefaultSettingsForNewPresentationGen() {
    var settingsArray = PresentationSetting.getDefaultSettingsOfLevel('presentation');
    return yield PresentationSetting.create(settingsArray);
  }),
