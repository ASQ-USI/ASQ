...
var denormalizeActivitySessionEvent = coroutine(function *denormalizeQuestionSessionEventGen (sEvent){
  var userPromise = getUserFromWhitelistEntry(sEvent.data.user, 'user');
