...
module.exports =  function(socketUtils){
  ...
  const ctrlForwardQuestionToRoles = function (evtName, question, sessionId) {
    socketUtils.emitToRoles(evtName, question, sessionId, 'folo');
    socketUtils.emitToRoles(evtName, question, sessionId, 'ghost');
  };
  ...
  return {
    ...
    ctrlForwardQuestionToRoles: ctrlForwardQuestionToRoles
  }
}
