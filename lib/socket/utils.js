...
module.exports =  function(io, client){
  ...
  var deleteAndNotify = function(socket, sid, userInfo, namespace, toNotify) {
    var args       = Array.prototype.slice.call(arguments, 3);
  ...
  var getNumOfConnectedClients = function(namespace, room){
    var num=0;
    try{
  ...
  var saveConnectionToRedis = function(token, socket){
    return nodefn.call(client.lpush.bind(client), token.toString(), socket.id)
  }

  var removeConnectionFromRedis = function(token, socket){
    return nodefn.call(
