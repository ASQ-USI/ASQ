...
module.exports =  function(io, client, socketEmitter){
  ...
  var sendConnectedClients = function sendConnectedClients(sessionId, namespaces) {
    ...
    Promise.map(['/folo', '/ctrl', '/ghost'], function(nspc){
      ...
      notifyBinded.apply(this, allNspcs);
    })
  }
  ...
  socketEmitter.on('notifyNamespaces', function(evt){
   notifyNamespaces(evt.evtName, evt.event, evt.sessionId, evt.namespaces);
  });
