...
var getSessionStats = exports.getSessionStats = gen.lift (
  ...
  var userData = users.map(function(user){
    ...
    return{
      'user': {
        ...
        'totalTime': totalTime ,
        'score': 0,
        'completed': (user.sessionData.answeredAllDate ? true: false)
      },
...
exports.getUserSessionStats = gen.lift (
  ...
  try{
    ...
    appLogger.error("Session %s not found", sessionId);
    appLogger.error(err.message, { err: err.stack });
  }
