...
module.exports =  function(io, client){
  ...
  var ctrlConnect = function(socket) {
    ...
    notifyNamespaces('asq:ctrl-connected', evt, sessionId,
        'ctrl', 'wtap', 'folo');
    sendConnectedClients(sessionId, null, 'ctrl');
  ...
  var foloConnect = function(socket) {
    ...
    sendConnectedClients(sessionId, screenName, 'ctrl', 'wtap', 'folo');
  ...
  var sendConnectedClients = function(sessionId, screenName, namespaces) {
    ...
    notifyBinded.apply(this, Array.prototype.slice.call(arguments, 2));
  }
