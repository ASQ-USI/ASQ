...
module.exports =  function(io, client){
  ...
  var goto = function(socket, evt) {
    ...
    // TODO load adpater based on presentation type
    ...
    getSession(socket)
      .then(function(session){
        ...
        return when.all([
          currentSession.questionsForSlide(nextSlide),
          currentSession.statQuestionsForSlide(nextSlide)
        ]);
      })
      .then(function(results) {

        currentSession.activeSlide = nextSlide;
