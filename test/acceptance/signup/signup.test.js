module.exports = {
  ...
  "signup a user" : function (browser) {
    ...
    signupPage.signupUser(browser.globals.users.signupOnlyUser);

    browser
      .waitForElementVisible('body[data-view-name="presentations"]', 100000, 'Should take him to the presentations page')
      .end();
  }
};
